...
IMXi_interaction_par = open("D:\\Documents\\Egor\\study\\Diplom\\IMXi_interaction_alpha0.0_sigma1.0_chil1.0_hx0.0500_ht0.0100.txt", 'r')
IMXi_without_interaction_par = open("D:\\Documents\\Egor\\study\\Diplom\\IMXi_without_interaction_alpha0.0_sigma1.0_chil1.0_hx0.0500_ht0.0100.txt", 'r')
REXi_interaction_par = open("D:\\Documents\\Egor\\study\\Diplom\\REXi_interaction_alpha0.0_sigma1.0_chil1.0_hx0.0500_ht0.0100.txt", 'r')
REXi_without_interaction_par = open("D:\\Documents\\Egor\\study\\Diplom\\REXi_without_interaction_alpha0.0_sigma1.0_chil1.0_hx0.0500_ht0.0100.txt", 'r')


IMXi_interaction_zero_deg = open("D:\\Documents\\Egor\\study\\Diplom\\IMXi_interaction_alpha0.0_sigma1.0_chil1.0_xi0.0PI_hx0.0500_ht0.0100.txt", 'r')
IMXi_without_interaction_zero_deg = open("D:\\Documents\\Egor\\study\\Diplom\\IMXi_without_interaction_alpha0.0_sigma1.0_chil1.0_xi0.0PI_hx0.0500_ht0.0100.txt", 'r')
REXi_interaction_zero_deg = open("D:\\Documents\\Egor\\study\\Diplom\\REXi_interaction_alpha0.0_sigma1.0_chil1.0_xi0.0PI_hx0.0500_ht0.0100.txt", 'r')
REXi_without_interaction_zero_deg = open("D:\\Documents\\Egor\\study\\Diplom\\REXi_without_interaction_alpha0.0_sigma1.0_chil1.0_xi0.0PI_hx0.0500_ht0.0100.txt", 'r')
